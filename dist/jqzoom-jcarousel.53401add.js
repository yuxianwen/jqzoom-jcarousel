...
},{"./..\\images\\movebar.jpg":[["movebar.df64abfc.jpg",8],8],"_css_loader":7}],4:[function(require,module,exports) {
...
(function ($) {
    ...
    $jc.fn.extend({
        ...
        prev: function prev() {
            ...
            if (this.tail != null && this.inTail) this.scrollTail(true);else this.scroll((this.options.wrap == 'both' || this.options.wrap == 'first') && this.options.size != null && this.first == 1 ? this.options.size : this.first - this.options.scroll);
        },
        ...
        callback: function callback(cb, evt, state, i1, i2, i3, i4) {
            if (this.options[cb] == undefined || _typeof(this.options[cb]) != 'object' && evt != 'onAfterAnimation') return;
...
(function ($) {
	$.fn.jqueryzoom = function (options) {
		...
		$(this).hover(function () {
			...
			if (bigimgWidth > settings.xzoom && bigimgHight > settings.yzoom) {
...
var _jquery = require('./src/js/jquery');
...
},{"./src/css/style.scss":3,"./src/js/jquery":4,"./src/js/jcarousel":5,"./src/js/jqzoom":6}],10:[function(require,module,exports) {
...
//# sourceMappingURL=/jqzoom-jcarousel.53401add.map